...
class DataValidationConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.valid_train_data_dir:str=os.path.join(
            self.data_validation_dir,training_pipeline.TRAIN_FILE_NAME
        )
        self.invalid_train_data_dir:str=os.path.join(
            self.data_validation_dir,training_pipeline.TRAIN_FILE_NAME
        )
        self.valid_test_data_dir:str=os.path.join(
            self.data_validation_dir,training_pipeline.TEST_FILE_NAME
        )
        self.invalid_test_data_dir:str=os.path.join(
            self.data_validation_dir,training_pipeline.TEST_FILE_NAME
        )
